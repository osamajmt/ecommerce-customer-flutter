...
import 'package:ecommerce_app/controller/order/archived_orders_controller.dart';
...
class ArchivedOrders extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(title: Text("68".tr), centerTitle: true, elevation: 0),
      body: GetBuilder<ArchivedOrdersController>(
        builder: (controller) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, i) {
              final order = controller.archivedOrders[i];
              final ratingDialog = RatingDialog(
                ...
                image: Image.asset(ImageAsset.LogoImageAsset, height: 120),
